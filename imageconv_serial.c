...
int leftsobel[3][3] = {{1,0,-1},{2,0,-2},{1,0,-1}};

PPMImage * convolution(PPMImage * im,int kernel[3][3],int h){
	int sum=0;
...
int main(int argc, char* argv[]){
  ...
  for(i=0;i<6;i++){
	  ...
	  PPMImage * x = convolution(image,emboss,1);
